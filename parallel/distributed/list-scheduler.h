...
public:
  ...
  static void SetLocalListv2 (bool value);
...
//  static uint64_t m_symTime;
  ...
  static uint64_t m_grantedTime[4];
  static uint64_t m_smallestTime[4];
  static uint64_t m_lookAhead[4];
